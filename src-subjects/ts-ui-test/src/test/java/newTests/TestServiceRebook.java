...
public class TestServiceRebook {
    ...
    public void getOrders()throws Exception{
        ...
        WebElement elementOrdertypeGTCJ = driver.findElement(By.xpath("//*[@id='microservices']/div[14]/div[1]/h3/input[1]")); // Antes era div[4]...
        WebElement elementOrdertypePT = driver.findElement(By.xpath("//*[@id='microservices']/div[14]/div[1]/h3/input[2]")); // Antes era div[4]...
...
//            System.out.println("False，Status of Sign In btn is NULL!");
        ...
        else if(statusRebook.startsWith("You")) {
        	// adicionado porque mesmo obedecendo as restrições a mensagem é lançada.
        	String msg = "You can only change the ticket before the train start or within 2 hours after the train start.";
        	Assert.assertEquals(statusRebook.equalsIgnoreCase(msg), true);
        }
        else {
