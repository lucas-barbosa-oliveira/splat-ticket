...
import splat.SPLatJS;
import splat.Variables;
import trie.TrieST;

public class BacktrackerJS {
	...
	public BacktrackerJS(boolean isPureSPLat, boolean frun, TrieST<Boolean> gTrie) {
//		this.firstRun = frun;
		this.firstRun = true;
	...
	public BacktrackerJS clone() {
		BacktrackerJS clone = new BacktrackerJS(this.pureSPLat, this.firstRun, this.generalTrie);
...
//	this.forceChoose = false;
	...
	private int choose(int lo, int hi, FeatureVar fvar, Variables vars) {
		...
		if (SPLatJS.validate && !SPLatJS.shouldSample) {
			boolean isSAT;
			// String pa = "";
			do {
...
//			System.err.println("CSTIME = " + csTime);
	...
	public void addAll(BacktrackerJS st) {
